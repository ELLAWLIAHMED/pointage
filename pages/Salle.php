            ...
            <div class="row">
                <div class="col-sm-6 mb-2">
                   ...
                   <!-- <input class="" type="text" id="id" hidden> -->
                    <input class="form-control" type="text" id="numero" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">type : </label>
                    <input class="form-control" type="text" id="type" required>
                </div>
            </div>
            <div class="row">
                <div class="col">
...
<script src="script/salle.js" type="text/javascript"></script>
<?php
