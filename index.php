            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <!-- added by ahmed -->
                        <li>
                            <a href="./index.php?p=machine"><i class="fas fa-laptop"></i>Machines</a>
                        </li>
                         <li>
                            <a href="./index.php?p=salle"><i class="fas fa-laptop"></i>Salles</a>
                        </li>
                        <li class="header-menu">
                ...
                <?php
                    if( isset($_GET['p']) && $_GET['p'] != ""){
                        if($_GET['p']=="departement"){
                            ...
                            //added by ahmed
                        }elseif($_GET['p']=="machine"){
                            include_once './pages/Machine.php';
                        }
                        elseif($_GET['p']=="salle"){
                            include_once './pages/Salle.php';
                        }
                    }else{
                        include_once './pages/statistiques.php';
                    }
